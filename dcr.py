...
if not os.path.exists('dcpu'):
    print "You don't have the emulator code. Extracting it now"
    if not os.path.exists('dcpu.jar.zip'):
        print "You don't even have the .jar file! Downloading it now"
...
if not os.path.exists('notches_mem.dmp'):
    print "You don't have notch's test program. Creating it now"
...
if not os.path.exists('hello.out'):
    print "You don't have Isharacomix's test program. Creating it now"
...
if not os.path.exists('run.bat'):
    print "You don't have my little utility file. Creating it now"
    fh=open('run.bat', 'wb')
    fh.write(run_bat)
    fh.close()
...
if not os.path.exists(filename):
    print 'Specified file does not exist. Using default file'
